...
cd $WORKSPACE &amp;&amp; $WORKSPACE/run_chroot.py --distro=UBUNTUDISTRO --arch=ARCH --hdd-scratch=/home/rosbuild/install_dir --script=$WORKSPACE/script.sh
"""
